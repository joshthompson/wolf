...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_common_models_wolf_game_model__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__app_common_models_wolf_game_model___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__app_common_models_wolf_game_model__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_common_models_player_model__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_common_models_player_model___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__app_common_models_player_model__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_common_models_game_code_model__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_common_models_game_code_model___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__app_common_models_game_code_model__);
...
var fetchUpdates = function (timeout) {
    if (game) {
        ...
        request('GET', "/api/game/" + game.getId()).getBody('utf8').then(JSON.parse).done(function (g) {
            game = new __WEBPACK_IMPORTED_MODULE_0__app_common_models_wolf_game_model__["WolfGame"](g);
...
var setupGame = function () {
    ...
    if (load) {
        game = new __WEBPACK_IMPORTED_MODULE_0__app_common_models_wolf_game_model__["WolfGame"](Cookie.getJSON('game'));
    ...
    document.getElementById('create-btn').onclick = function (event) {
        game = new __WEBPACK_IMPORTED_MODULE_0__app_common_models_wolf_game_model__["WolfGame"]();
    ...
    document.getElementById('join-btn').onclick = function (event) {
        var player = new __WEBPACK_IMPORTED_MODULE_1__app_common_models_player_model__["Player"](document.getElementById('player-name').value);
        var code = new __WEBPACK_IMPORTED_MODULE_2__app_common_models_game_code_model__["GameCode"](document.getElementById('game-code').value);
...
throw new Error("Module parse failed: Unexpected token (2:3)\nYou may need an appropriate loader to handle this file type.\n| export class Player {\n| \tid: number\n| \tname: string\n| \tavatar: string");
...
var GenericResponse = __webpack_require__(10);
var Promise = __webpack_require__(1);
var ResponsePromise_1 = __webpack_require__(19);
exports.ResponsePromise = ResponsePromise_1.ResponsePromise;
var handle_qs_1 = __webpack_require__(20);
...
exports.__esModule = true;
var qs_1 = __webpack_require__(21);
